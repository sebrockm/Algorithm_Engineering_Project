...
EXTERN SCIP_DECL_HEURINIT(heurInitRounding);

EXTERN SCIP_DECL_HEURINITSOL(heurInitsolRounding);

EXTERN SCIP_DECL_HEUREXEC(heurExecRounding);

EXTERN SCIP_SOL* RoundingHeuGetSolution(void);
